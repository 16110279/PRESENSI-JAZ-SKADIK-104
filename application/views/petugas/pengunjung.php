   ...
   <div class="container-fluid">
           ...
           <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
               ...
               <div class="dropdown no-arrow">
                   ...
                   <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                       <a class="dropdown-item" href="<?= base_url('petugas/daftar_pengunjung'); ?>">Daftar Pengunjung</a>
                   </div>
               </div>
           </div>
                   ...
                   <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                       ...
                       <tbody>
                           ...
                           <?php foreach ($record_pengunjung as $rp) : ?>
                               <tr>
                                   <th scope="row"><?= $i; ?></th>
                                   <td><?= $rp['nama_pengunjung']; ?></td>
                                   <td><?= $rp['nama_keperluan']; ?></td>

                                   <td><?php
                                            if ($rp['id_member'] != '' && $rp['id_umum'] == '') {
                                                echo 'Member';
                                            }

                                            if ($rp['id_umum'] != '' && $rp['id_member'] == '') {
                                                echo 'Umum';
                                            }
       ...
       <div class="float-right">
           <button type="button" class="btn btn-primary mb-3 tombolTambahData" data-toggle="modal" data-target="#modalKeperluan"> Add New Menu </button>
       </div>
   </div>
   <!-- /.container-fluid -->
